  ...
  <div class="select-none font-mono text-xs">
    ...
    >
      ...
      <div class="flex items-center gap-1 flex-shrink-0">
        ...
        <span
          v-if="node.isStaged"
          class="text-[9px] font-bold px-1 rounded bg-green-500/20 text-green-400"
        >
          {{ node.status }}
        </span>
        <span
          v-else-if="node.isUntracked"
          class="text-[9px] font-bold px-1 rounded bg-emerald-400/20 text-emerald-400"
        >
          U
        </span>
        <span
          v-else
          class="text-[9px] font-bold px-1 rounded bg-amber-400/20 text-amber-400"
        >
          {{ node.status }}
        </span>
